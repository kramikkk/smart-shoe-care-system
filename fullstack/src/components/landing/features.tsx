...
export default function Features() {
    ...
    return (
        <section ref={containerRef} id="features" className="relative py-32 overflow-hidden bg-background">
            {/* Background blobs */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {features.map((feature, i) => (
                        <div 
                            ...
                            className="feature-card group relative p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-colors overflow-hidden"
                        >
                            {/* Gradient hover background */}
                            <div className={`absolute inset-0 bg-gradient-to-br ${feature.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                            
                            <div className="relative z-10">
                                <div className="feature-icon w-16 h-16 flex items-center justify-center rounded-2xl bg-white/[0.05] mb-6 group-hover:scale-110 transition-transform duration-500">
                                    {feature.icon}
                                </div>
